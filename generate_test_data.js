...
// Test accounts
const testAccounts = [
  { name: "Test1", email: "test1@gujc71.com" },
  { name: "Test2", email: "test2@gujc71.com" },
  { name: "Test3", email: "test3@gujc71.com" },
  { name: "Test4", email: "test4@gujc71.com" },
  { name: "Test5", email: "test5@gujc71.com" },
  { name: "Test6", email: "test6@gujc71.com" },
  { name: "Test7", email: "test7@gujc71.com" },
  { name: "Test8", email: "test8@gujc71.com" },
  { name: "Test9", email: "test9@gujc71.com" },
  { name: "Test10", email: "test10@gujc71.com" }
];

// Advertising-related subject templates in English
const subjectTemplates = [
  "Ad Campaign Proposal Review Request",
  "New Product Marketing Strategy Meeting",
  "Online Advertising Performance Report",
  "Brand Promotion Budget Approval",
  "Social Media Ad Content Review",
  "Creative Production Schedule",
  "Digital Marketing ROI Analysis",
  "Client Meeting Results Sharing",
  "Marketing KPI Achievement Report",
  "Ad Creative Approval Request",
  "Target Audience Analysis Report",
  "Advertising Effectiveness Measurement",
  "Marketing Budget Allocation Plan",
  "Branding Strategy Revision",
  "Ad Platform Performance Comparison",
  "Promotional Event Planning",
  "Ad Copy Review and Revision",
  "Marketing Team Task Assignment",
  "Ad Campaign Schedule Adjustment",
  "Customer Feedback Analysis Report",
  "Competitor Ad Analysis",
  "Advertising Cost Optimization Plan",
  "Brand Awareness Survey Results",
  "Marketing Automation Tool Implementation",
  "Ad Performance Improvement Proposal"
];
